  ...
  return (
    <div>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        {/* ✅ Parent Container Start (bada kar diya) */}
        <div className="max-w-screen-2xl mx-auto w-full ">

          {/* Heading */}
          <div className="bg-blue-50 py-16 w-full overflow-hidden text-center">
              ...
              {blogs.map((blog) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col gap-2 flex-1">
                    ...
                    <Link href={blog.link}>
                      <button className="mt-2 self-start px-3 py-1 bg-blue-900 text-white rounded-lg transition text-sm">
                        Read More
                      </button>
                    </Link>
                  </div>
