...
export default function Islamabad() {
  ...
  const HotelList = [
    ...
    {
      id: 2,
      hotelname: "Hotel S.R Lounge Multan",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
    ...
    {
      id: 3,
      hotelname: "The Signature Hotel Multan",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
    ...
    {
      id: 4,
      hotelname: "Hotel Grace Inn Multan",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
    ...
    {
      id: 5,
      hotelname: "Aimys Villa Guest House",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
