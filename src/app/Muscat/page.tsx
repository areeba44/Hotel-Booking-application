...
export default function Islamabad() {
  ...
  const HotelList = [
    ...
    {
      id: 2,
      hotelname: "Grand Millennium Muscat",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
    ...
    {
      id: 3,
      hotelname: "Mövenpick Hotel and Apartments Ghala Muscat",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
