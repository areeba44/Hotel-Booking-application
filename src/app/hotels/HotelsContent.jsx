      ...
      if (parsedData) {
        ...
        const fetchHotelsData = async () => {
          try {
            ...
            const response = await axios.post(`http://172.16.253.49:5001/hotels?action=get_hotels_searches`, JSON.stringify({ params: json }), {
              headers: {
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex items-center gap-1 text-yellow-500 text-sm">
                      {/* {[...Array(h.HotelRating)].map((_, i) => (
                        <FaStar key={i} />
                      ))} */}
                      {/* <span className="text-gray-600 ml-2">{h.reviews}</span> */}
                    </div>
                    ...
                    <div className="flex flex-col gap-2 text-xs text-gray-600 mt-1">
                      ...
                      {/* <span className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded-md">
                        <FaGlobe size={12} /> {h.source1}
                        <p className="relative left-93">{h.source2}</p>
                      </span>

                      <span className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded-md">
                        <FaGlobe size={12} /> {h.source3}
                        <p className="relative left-97">{h.source4}</p>
                      </span> */}
                      ...
                      {/* <div className="relative">
                        ...
                        >
                          <FaGlobe size={12} /> {h.source5}
                          <p className="relative left-88">{h.source6}</p>
                  ...
                  {/* <div className="flex flex-col justify-center items-end pr-2 min-w-[90px]">
                    ...
                    <span className="font-bold text-base">{h.price}</span>
