...
export default function Islamabad() {
  ...
  const HotelList = [
    {
      id: 1,
      hotelname: "Grand Berkshire Signature Hotel operated by Berkshire Hotels & Resorts UK",
      location: "Faisalabad",
      rating: 4,
    ...
    {
      id: 2,
      hotelname: "Travel Inn islamabad",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
  ...
  return (
    <div className="w-full bg-white shadow-xl border-b border-gray-200">
      ...
      <div className="max-w-7xl mx-auto mt-6 px-4">
        <h1 className="text-2xl font-semibold mb-4">Available Hotels</h1>
              ...
              >
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href={hotel.link}>
                    <div className="w-full sm:w-40 h-32 relative rounded-lg overflow-hidden cursor-pointer">
                      <Image
                        src={hotel.image}
                        alt={hotel.hotelname}
                        fill
