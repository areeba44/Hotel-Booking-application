        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-600 leading-relaxed mb-10">
              Stay Haven is a modern hotel booking platform built to connect travelers
              with carefully verified hotels, resorts, and guest houses across multiple
              destinations. We aim to remove the complexity from travel planning by
              offering a reliable space where guests can discover stays that meet
              their comfort, quality, and budget expectations.
            </p>
