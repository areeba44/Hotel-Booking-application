...
const images = [
  { src: "/I1.PNG", label: "Room" },
  { src: "/I2.PNG", label: "Garden" },
  { src: "/I3.PNG", label: "TV Lounge" },
  { src: "/I4.PNG", label: "Dining" },
  { src: "/I5.PNG", label: "Reception" },
  { src: "/I6.PNG", label: "Balcony" },
  { src: "/I7.PNG", label: "Lobby" },
  { src: "/I8.PNG", label: "Restaurant" },
];
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl p-6 overflow-y-auto max-h-[90vh]">
        ...
        {/* Hotel Name */}
        <h1 className="text-2xl font-bold mb-4">Hotel One Faisalabad</h1>
