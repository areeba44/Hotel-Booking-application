          ...
          <div className="bg-white rounded-2xl shadow-md p-6 max-w-xl w-full">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="relative">
                ...
                />
                <label className="absolute bottom-0 right-0 bg-amber-500 rounded-full p-2 cursor-pointer hover:bg-amber-600">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border rounded-xl px-4 py-2 mt-1 focus:ring-2 focus:ring-amber-400 outline-none"
                />
              </div>
              <div>
              ...
              <button className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-xl w-full mt-2 shadow-md">
                Save Changes
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 max-w-xl w-full">
            ...
            <div className="flex flex-col space-y-3">
              <input
                type="email"
                placeholder="Your Email"
                className="w-full border rounded-xl px-4 py-2 focus:ring-2 focus:ring-amber-400 outline-none"
              />
              <button className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-xl w-full shadow-md">
                Send Reset Link
              </button>
            </div>
          </div>
