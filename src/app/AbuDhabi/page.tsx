...
export default function Islamabad() {
  ...
  const HotelList = [
    {
      id: 1,
      hotelname: "Royal Rose Hotel Abu Dhabi, Curio Collection by Hilton",
      location: "Faisalabad",
      rating: 4,
    ...
    {
      id: 3,
      hotelname: "Sheraton Abu Dhabi Hotel & Resort",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
    ...
    {
      id: 5,
      hotelname: "Radisson Blu Hotel & Resort, Abu Dhabi Corniche",
      location: "Faisalabad",
      rating: 5,
      reviews: "Amazing (640)",
      source1: "Booking.com",
